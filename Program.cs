    ...
    class temps
    {
        ...
        private static void convertTemp(char type, int numToConvert)
        {
            ...
            if (type == 'F')
            {
                ...
                Console.WriteLine($"{numToConvert} degrees celsius to farenheit is  {convertedValue}");
            }
            else
            {
                convertedValue = (numToConvert - 32) * 5 / 9;
                Console.WriteLine($"{numToConvert} degrees farenheit to celsius is  {convertedValue}");
